  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("OTT PLATFORMS", style: TextStyle(fontSize: 15,color: Colors.white)),
          centerTitle: true,
          actions: [
            IconButton(
                onPressed: () async {
                  await inAppWebViewController.loadUrl(
                      urlRequest: URLRequest(
                          url: Uri.parse("${global.all_websites[0]['link']}")));
                },
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, i) => InkWell(
                          ...
                          child: Container(
                            ...
                            alignment: Alignment.center,
                            child: 
                              Image(image: AssetImage("${global.all_websites[i]['name']}"),fit: BoxFit.fill,)
                          ),
                        ),),
                  ),),
            ],
        ...
        floatingActionButton: Row(
          ...
          children: [
            FloatingActionButton(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: TextFormField(
                          decoration: const InputDecoration(
                              border: OutlineInputBorder(),hintText: 'Search Your Content Here..'),
                          onChanged: (val) {
                            inAppWebViewController.loadUrl(
                                urlRequest: URLRequest(
                                    url: Uri.parse(
                ...
                child: const Icon(Icons.search,color: Colors.black,),backgroundColor: Colors.white),
            ...
            FloatingActionButton(
                ...
                child: const Icon(Icons.bookmark,color: Colors.black,),backgroundColor: Colors.white),
            const SizedBox(width: 10),
            FloatingActionButton(
                heroTag: null,
                onPressed: () async {
                ...
                child: const Icon(Icons.cancel,color: Colors.black,),backgroundColor: Colors.white),
          ],
        ),
        body: Column(
          children: [
            _progress < 1
              ...
              child: LinearProgressIndicator(
                value: _progress,color: Colors.white,
                backgroundColor: Colors.black,
              ),
            )
                : SizedBox(),
